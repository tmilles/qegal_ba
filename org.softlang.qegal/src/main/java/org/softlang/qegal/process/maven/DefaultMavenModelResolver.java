...
public class DefaultMavenModelResolver implements ModelResolver {
	...
	private static Map<Coordinate, ModelSource> modelSourceCache;

	public DefaultMavenModelResolver(GitModelSource gitModelSource, CloseableHttpClient httpClient,
			Repository defaultMavenRepository, Path currentPath, Map<Path, String> pathToObjectId) {
		...
		modelSourceCache = new HashMap<>();
	}

	private URL buildPomUrl(String groupId, String artifactId, String version, String baseUrl)
	...
	public ModelSource resolveModel(String groupId, String artifactId, String version)
		...
		try {
			...
			String message = "(" + groupId + "," + artifactId + "," + version + ") not found in repositories"
					+ repositoryUrls;
	...
	public void addRepository(Repository repository, boolean replace) throws InvalidRepositoryException {
		List<Repository> removes = repositories.stream().filter(x -> x.getId().equals(repository.getId()))
	...
	public ModelResolver newCopy() {
		return new DefaultMavenModelResolver(gitModelSource, httpClient, defaultMavenRepository, currentPath,
				pathToObjectId);
	}
}
